  ...
  connectedCallback() {
    this.innerHTML = `
        ...
        <nav class="nav-bottom">
          <div class="container">
            <ul class="menu mb-0 ps-0">
              ...
              <li data-lang="en"><a href="/map.html" target="_blank">PROJECTS LOCATION</a></li>
              <li data-lang="th"><a href="/map.html" target="_blank">แผนที่โครงการ</a></li>
        ...
        <ul class="menu-moblie mb-0 ps-0">
          <li data-lang="en" id="project-toggle" onclick="projectToggle(1)"><span style="cursor:pointer">PROJECTS<i class="fas fa-caret-down"></i></span></li>
          <li data-lang="th" id="project-toggle" onclick="projectToggle(1)"><span style="cursor:pointer">โครงการ<i class="fas fa-caret-down"></i></span></li>
          <li data-lang="ch" id="project-toggle" onclick="projectToggle(1)"><span style="cursor:pointer">项目介绍<i class="fas fa-caret-down"></i></span></li>
          <div class="projects-box" id="projects-box">
            <a data-lang="en" href="/projects.html"><p class="mb-0">The One Estate Developer</p></a>
            <a data-lang="th" href="/projects.html"><p class="mb-0">เดอะ วัน เอสเตท ดีเวลลอปเม้นท์</p></a>
            <a data-lang="ch" href="/projects.html"><p class="mb-0">The One Estate Developer</p></a>
            <div class="theones-menus-moblie ms-4">
              ...
              <div data-lang="en"><a href="/projects.html#past-project">Past Project</a></div>
